...
**脚本路径**：`scripts/create-worktree.sh`

```bash
# 用法
bash scripts/create-worktree.sh feature F3.1 ocr-acceleration
bash scripts/create-worktree.sh fix F3.1 hotkey-conflict
bash scripts/create-worktree.sh docs ai-git-workflow
bash scripts/create-worktree.sh refactor core-state-machine
```
