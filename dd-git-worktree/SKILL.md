...
**创建脚本**：`../dd-ai-git-workflow/scripts/create-worktree.sh`

```bash
# 用法
../dd-ai-git-workflow/scripts/create-worktree.sh feature F3.1 ocr-acceleration
../dd-ai-git-workflow/scripts/create-worktree.sh fix F3.1 hotkey-conflict
../dd-ai-git-workflow/scripts/create-worktree.sh docs ai-git-workflow
../dd-ai-git-workflow/scripts/create-worktree.sh refactor core-state-machine
```
