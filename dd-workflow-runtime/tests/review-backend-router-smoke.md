...
| L7 review result | 各真实 backend 返回 `dd-review-result/1` 并携带 baseline/reviewed/unreadable | PENDING/PARTIAL（`mcp-review`、`opencode-cli` PASS 能力贯通、verdict=FINDINGS；其他 backend PENDING） |
