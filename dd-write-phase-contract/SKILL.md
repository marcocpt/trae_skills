...
**完整红线机制遵循 [dd-write-requirements](../dd-write-requirements/SKILL.md)：**
...
阶段合同场景同样适用上述红线，不得以"阶段合同需要更具体"为由保留代码符号。需要区分 Requirements 与 Design 时，遵循 dd-write-requirements 的层级原则。
